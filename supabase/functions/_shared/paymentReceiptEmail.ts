...
function receiptTemplate(p: { title: string; lastName: string; propertyAddr: string; amount: string; guaranteeRef: string; intendedFor: string }): { subject: string; html: string } {
